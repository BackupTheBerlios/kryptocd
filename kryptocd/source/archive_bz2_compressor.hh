...
namespace KryptoCD {
  /*
    Class Bz2_Compressor compresses the data pouring in through a file
    descriptor.
  */
  class Bz2_Compressor : public Childprocess {
  public:
    ...
    // inside this process).
    // If they are left unspecified (-1), the Bz2_Compressor object
    // will create pipes and make their fd's available.
    // compression is the parameter between 1 and 9 passed to bzip2.
    Bz2_Compressor(const std::string & bzip2_executable,
  ...
  private:
    ...
    // to initialize the parent class of Bz2_Compressor, Childprocess.
    static
