...
namespace KryptoCD {
  ...
  private:
    ...
    /**
     * a Flag indicating that the source filedescriptor has not been closed by
     * closeSource
     */
    bool sourceOpen;

    /**
     * a Flag indicating that the sink filedescriptor has not been closed by
     * closeSink
     */
    bool sinkOpen;
  ...
  public:
     ...
     *
     * @return  -1 if the source file descriptor has been closed by this object,
     *          and if not, the number of that file descriptor. If this file
     *          dascriptor has been closed directly with close outside this
     *          object, it will not know and still return the now closed file
     *          descriptor.
     */
    int
    getSourceFd(void)const;

    /**
     * access the filedescriptors:
     * sink is for writing to
     *
     * @return  -1 if the sink file descriptor has been closed by this object,
     *          and if not, the number of that file descriptor. If this file
     *          dascriptor has been closed directly with close outside this
     *          object, it will not know and still return the now closed file
     *          descriptor.
